	...
	<div style="margin-left:0;" class="container">
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<p style="position:relative; float:left; width:850px;">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Commodi, vero recusandae. Unde quidem repellat praesentium, commodi rem et suscipit eveniet, magni aut ducimus inventore eaque voluptates possimus omnis cumque modi?</p>
				...
				<div style="float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Small Size Bed</label> <label style="color:red;">Rp. 2,000.00</label></center>
				</div>
				<div style="float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label style="color:red;">Rp. 800.00</label></center>
				</div>
				<div style="float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>1 Medium Size Bed</label> <label style="color:red;">Rp. 2,400.00 </label></center>
				</div>
				<br style="clear:both;" />
				<br />
				<div style="float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>2 Medium Size Bed</label> <label style="color:red;">Rp. 2,800.00 </label></center>
				</div>
				<div style="float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Matrimonial</label> <label style="color:red;">Rp. 3,800.00 </label></center>
				</div>
				<div style="float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Matrimonial</label> <label style="color:red;">Rp. 4,000.00 </label></center>
				</div>
				<br style="clear:both;" />
				<br />
				<br />
